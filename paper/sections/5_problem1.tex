...
取 $\theta=120^\circ$、$\alpha=1.5^\circ$、$D_0=70\text{ m}$，对题面表 1 所列 9 个位置代入式 \eqref{eq:q1_depth}--\eqref{eq:q1_overlap}，结果如表 2 所示。
...
随 $x$ 由 $-800\text{ m}$ 增至 $800\text{ m}$，水深由 $90.95\text{ m}$ 降至 $49.05\text{ m}$，覆盖宽度由 $315.71\text{ m}$ 单调降至 $170.27\text{ m}$；相邻重叠率由 $35.70\%$ 降至 $-12.36\%$，在 $x=600\text{ m}$ 处已转为负值，表明浅水侧按固定间距布线会出现漏测。变化趋势见图 2。
...
在 $x=0$、$D_0=70\text{ m}$ 处分别单独扰动坡度 $\alpha$ 与换能器开角 $\theta$，覆盖宽度变化如表 3 所示。坡度由 $0.0^\circ$ 增至 $3.0^\circ$ 时，$W$ 仅由 $242.49\text{ m}$ 增至 $244.50\text{ m}$，变化约 $2.01\text{ m}$；开角由 $100^\circ$ 增至 $140^\circ$ 时，$W$ 由 $167.01\text{ m}$ 增至 $386.65\text{ m}$。在本题给定的小坡度范围内，坡度对覆盖宽度的影响较弱，换能器开角是决定覆盖宽度的主要参数。
